...
> To customize specific control, set `hideValidationMessage` to `true` and use `customComponent`. Then you can get the error messages in the component and control how to display them. See [Custom Components](../../v4/custom-components/custom-components_en.md).
...
| Property     | description                                                                      |
| :----------- | :------------------------------------------------------------------------------- |
| config       | Config of the FormArray. See [Form Array](../../v4/form-array/form-array_en.md). |
...
It will add a toggle functionality to the label of the FormGroup/FormArray to expand/collapse it's child. The `label` must be provided together.
...
| Property | Description                            |
| :------- | :------------------------------------- |
| label    | The label of this FormGroup/FormArray. |
